...
export default function MigrateSingleStudent({ classes }:allClasses) {
    ...
    return (
                ...
                >
                    <AccordionItem value="section-wise">
                        <AccordionTrigger className="px-6 py-4 cursor-pointer">Single Student Migrate</AccordionTrigger>
